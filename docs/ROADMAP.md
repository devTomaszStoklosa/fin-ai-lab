...
| p3-market-pulse | Ready for architect | Ready for architect | Ready for dev | P3-S1..S5 gotowe; S6 (tracing/koszt) spełnione bez nowego kodu — każde wywołanie LLM już przechodzi przez `core.llm`; S7 (harmonogram) czeka na decyzję Tomasza; S8 (evale/backtest) do zrobienia |

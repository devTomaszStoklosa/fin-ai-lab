...
| p4-news-classifier | Ready for architect | Ready for architect | Ready for dev | P4-S1..S3 (częściowo) gotowe — korpus, katalog tickerów, etykietowanie teachera (pojedyncze wywołania, Batch API porzucone), baseline klasy większościowej i TF-IDF+LR. Baseline few-shot LLM i dalsze etykietowanie czekają na reset dziennego limitu Gemini (wyczerpany 2026-09-18) |
| p5-investment-committee | Ready for architect | Ready for architect | Ready for dev | P5-S1 do zrobienia |

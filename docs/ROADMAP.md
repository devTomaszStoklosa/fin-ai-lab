...
| p4-news-classifier | Ready for architect | Ready for architect | Ready for dev | P4-S1 i S2 gotowe (korpus, katalog tickerów, etykietowanie teachera pojedynczymi wywołaniami — Batch API porzucone, wymaga billingu). Dzienny limit Gemini wyczerpany 2026-09-18, dalsze etykietowanie/S3 (baseline'y) czeka na reset |

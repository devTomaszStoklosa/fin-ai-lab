...
| Obszar | Stan |
|---|---|
| Kod | `lab-foundation`, P1 (`portfolio_xray`), P2 (`filings_rag`) i P3 (`market_pulse`) gotowe; P4 (`news_classifier`) S1-S2 gotowe, dalej czeka na reset dziennego limitu Gemini — patrz [ROADMAP.md](docs/ROADMAP.md) „Stan ticketów" |

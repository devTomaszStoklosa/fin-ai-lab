...
| Obszar | Stan |
|---|---|
| Kod | `lab-foundation`, P1 (`portfolio_xray`), P2 (`filings_rag`) i P3 (`market_pulse`) gotowe; P4 (`news_classifier`) S1-S3 częściowo, P5 (`investment_committee`) S1 gotowe — oba dalej czekają na reset dziennego limitu Gemini — patrz [ROADMAP.md](docs/ROADMAP.md) „Stan ticketów" |
